              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className="group relative flex items-center justify-center p-3 sm:p-4 rounded-full bg-[var(--background)] text-[#f9f7f3] transition-colors hover:text-white hover:bg-zinc-800"
